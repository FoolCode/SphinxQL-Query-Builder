...
class ConnectionTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetConnectionParams()
    {
        ...
        $this->connection->setConnectionParams('/var/run/sphinx.sock', 0);
        $this->assertSame(array('host' => null, 'port' => 0, 'socket' => '/var/run/sphinx.sock'), $this->connection->getConnectionParams());
    }
