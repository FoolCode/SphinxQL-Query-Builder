...
class ConnectionTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetConnectionInfo()
    {
        ...
        $this->assertSame(array('host' => '127.0.0.1', 'port' => 9306), $conn_info);

        // create a new connection and get info
        SphinxqlConnection::addConnection('nondefault', 'localhost', 9306);
        ...
        $this->assertSame(array('host' => '127.0.0.1', 'port' => 93067), $conn_info);
    }
